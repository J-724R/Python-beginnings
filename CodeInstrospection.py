...
# Python provides several functions and utilities for code 
#introspection.
...
# Often the most important one is the help function, since you 
# can use it to find what other functions do.
